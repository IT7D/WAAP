				...
				<form name="writeForm" method="post" action="${contextPath}/admin/notice/write.do" enctype="multipart/form-data">
					...
					<table>
						<tbody>
							<tr>
								<td>
									<label for="notice_title">제목</label><input type="text" id="notice_title" name="notice_title" class="chk" title="제목을 입력하세요." />
								</td>
							</tr>	
							<tr>
								<td>
									<label for="notice_cont">내용</label><textarea id="notice_cont" name="notice_cont" class="chk" title="내용을 입력하세요."></textarea>
								</td>
							</tr>
							<tr>
								<td>

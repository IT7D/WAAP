	...
	<div class="col-md-offset-3">
		<ul class="pagination">
			<c:if test="${pageMaker.prev}">
				<li><a
					href="${contextPath}/admin/adminServiceCustomerView.do${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
			</c:if>
			...
			<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
				<li><a
					href="${contextPath}/admin/adminService/serviceCustomerView.do${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
			</c:if>
		</ul>
	</div>
